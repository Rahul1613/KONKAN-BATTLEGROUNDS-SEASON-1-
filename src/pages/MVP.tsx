...
import { topKillersData } from '../lib/data'

export default function MVP() {
  const topKillers = topKillersData
  const maxKills = topKillers.length > 0 ? topKillers[0].kills : 1
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {topKillers.length === 0 ? (
          ...
          >
            ...
            <h2 className="font-bebas text-2xl md:text-3xl mb-3">STANDINGS IN PROGRESS</h2>
            <p className="font-inter text-sm text-white/50 max-w-md mx-auto">
              No MVP statistics are available yet. Standings will update automatically as matches are played!
            </p>
          </motion.div>
        ) : (
          <>
